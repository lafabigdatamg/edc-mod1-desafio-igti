...
def handler(event, context):
    ...
    cluster_id = client.run_job_flow(
        Name='EMR-Eric-IGTI-rais',
        ServiceRole='EMR_DefaultRole',
        JobFlowRole='EMR_EC2_DefaultRole',
        VisibleToAllUsers=True,
        LogUri='s3://igti-eric-rais2020-mod1/emr-logs',
        ...
        Steps=[{
            'Name': 'Transformacao para parquet',
                    ...
                    'HadoopJarStep': {
                        ...
                        'Args': [
                            ...
                            '--master', 'yarn',
                            '--deploy-mode', 'cluster',
                            's3://igti-eric-rais2020-mod1/emr-code/pyspark/emr_job_spark.py'
                        ]
                    }
        }],
    )
